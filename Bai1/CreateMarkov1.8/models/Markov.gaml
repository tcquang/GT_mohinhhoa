...
global {
	...
	action create_lstlanduse {
		...
		save lstLanduse_t1 to: "../kq/ds_loaidat_ht1.csv" type: "csv"  rewrite: true;
		save lstLanduse_t2 to: "../kq/ds_loaidat_ht2.csv" type: "csv"  rewrite: true;
	}
	...
	action create_markov {
	    ...
	    save tieude to: "../kq/matran_markov.csv" type: "csv"  rewrite: true;
	    save tieude to: "../kq/matran_chuyendoi.csv" type: "csv"  rewrite: true;
	    ...
	    loop ld_row over: lstLanduse_t1 {
	        ...
	        save row_changes to: "../kq/matran_chuyendoi.csv" type: "csv"  rewrite: false;
	        save row_markov to: "../kq/matran_markov.csv" type: "csv"  rewrite: false;
	    }
